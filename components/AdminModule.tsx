            ...
            <div className="space-y-12 animate-in slide-in-from-bottom-4">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  <div className="space-y-4">
                     ...
                     <input value={evolutionConfig.baseUrl} className="w-full px-8 py-5 bg-slate-50 dark:bg-slate-800 rounded-3xl font-bold border-none outline-none focus:ring-4 ring-indigo-500/10 shadow-inner" />
                  </div>
                  <div className="space-y-4">
                     <label className="text-[10px] font-black uppercase text-slate-400 px-4">Master API Key</label>
                     <input type="password" value={evolutionConfig.apiKey} className="w-full px-8 py-5 bg-slate-50 dark:bg-slate-800 rounded-3xl font-bold border-none outline-none focus:ring-4 ring-indigo-500/10 shadow-inner" />
                  </div>
               </div>
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  <div className="space-y-4">
                     ...
                     <input value={n8nConfig.baseUrl} onChange={e => setN8nConfig({...n8nConfig, baseUrl: e.target.value})} className="w-full px-8 py-5 bg-slate-50 dark:bg-slate-800 rounded-3xl font-bold border-none outline-none focus:ring-4 ring-orange-500/10 shadow-inner" />
                  </div>
                  <div className="space-y-4">
                     <label className="text-[10px] font-black uppercase text-slate-400 px-4">Cluster API Key</label>
                     <input type="password" value={n8nConfig.apiKey} onChange={e => setN8nConfig({...n8nConfig, apiKey: e.target.value})} className="w-full px-8 py-5 bg-slate-50 dark:bg-slate-800 rounded-3xl font-bold border-none outline-none focus:ring-4 ring-orange-500/10 shadow-inner" />
                  </div>
               </div>

               <div className="pt-10 flex justify-end gap-4">
                  <button onClick={handleGlobalSync} className="px-12 py-6 bg-orange-600 text-white font-black rounded-3xl shadow-xl uppercase text-[10px] tracking-widest hover:scale-105 transition-all">Sincronizar Cluster Master</button>
               </div>
            </div>
         )}
